#' The following algorithm is a simpler, faster and much more effient way to 
#' calculate the present values of all future cash flows generated by the business
#' operation.
